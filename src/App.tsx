...
import MapBuildings from "./pages/community/CommunityMap/map";
...
export default function App(): JSX.Element {
    ...
    const [communityData, setCommunityData] = useState<EnergyCommunity | null>(null);
    const [selectedEquipment, setSelectedEquipment] = useState<SelectedEquipment[] | null>([]);
        ...
        <Routes>
            ...
            <Route element={<AuthGuard />}>
                ...
                <Route
                    ...
                    element={
                        <AppShell
                            communityData={isRecManager ? communityData : null}
                            selectedEquipment={isRecManager ? selectedEquipment : null}
                            setSelectedEquipment={handleSelectedEquipmentChange}
